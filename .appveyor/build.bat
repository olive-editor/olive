...
echo APPVEYOR_FORCED_BUILD = "%APPVEYOR_FORCED_BUILD%"& REM builds started by "New build" button or from the same API (True or undefined)
echo APPVEYOR_RE_BUILD = "%APPVEYOR_RE_BUILD%"& REM build started by "Re-build commit/PR" button of from the same API (True or undefined)
echo APPVEYOR_RE_RUN_INCOMPLETE = "%APPVEYOR_RE_RUN_INCOMPLETE%"& REM build job started by "Re-run incomplete" button of from the same API (True or undefined)
