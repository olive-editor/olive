...
public:
  ...
  void DragStart(const ValueParams &row, double abs_x, double abs_y, const olive::core::rational &time);
...
signals:
  void HandleStart(const olive::ValueParams &p, double x, double y, const olive::core::rational &time);
