...
public:
  ...
  void DragStart(const ValueParams &row, double abs_x, double abs_y, const rational &time);
...
signals:
  void HandleStart(const olive::ValueParams &p, double x, double y, const rational &time);
