...
#ifndef INTEGERSLIDERPARAMWIDGET_H
#define INTEGERSLIDERPARAMWIDGET_H

#include "numericsliderparamwidget.h"

namespace olive {

class IntegerSliderParamWidget : public NumericSliderParamWidget
{
  Q_OBJECT
public:
  IntegerSliderParamWidget(QObject *parent = nullptr);
...
#endif // INTEGERSLIDERPARAMWIDGET_H
