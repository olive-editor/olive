...
#ifndef FILEPARAMWIDGET_H
#define FILEPARAMWIDGET_H

#include "abstractparamwidget.h"

namespace olive {

class FileParamWidget : public AbstractParamWidget
{
  Q_OBJECT
public:
  explicit FileParamWidget(QObject *parent = nullptr);
