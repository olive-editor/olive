...
void CurvedConnectorItem::SetConnected(bool c)
{
  connected_ = c;
...
void CurvedConnectorItem::SetHighlighted(bool e)
{
  highlighted_ = e;
...
void CurvedConnectorItem::SetPoints(const QPointF &start, const QPointF &end)
{
  cached_start_ = start;
  cached_end_ = end;
...
void CurvedConnectorItem::SetCurved(bool e)
{
  curved_ = e;
...
void CurvedConnectorItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *)
{
...
NodeViewCommon::FlowDirection CurvedConnectorItem::GetFromDirection() const
{
  return NodeViewCommon::kLeftToRight;
}

NodeViewCommon::FlowDirection CurvedConnectorItem::GetToDirection() const
{
  return NodeViewCommon::kLeftToRight;
}

void CurvedConnectorItem::UpdateCurve()
{
  ...
  if (curved_) {
    ...
    NodeViewCommon::FlowDirection from_flow = GetFromDirection();
    NodeViewCommon::FlowDirection to_flow = GetToDirection();
