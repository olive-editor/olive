...

  {
...

    {
...

      {
        ...
        output_ch_layout_combo_->SetChannelLayout(AudioChannelLayout::fromString(OLIVE_CONFIG("AudioOutputChannelLayout").toString()));
        ...
        output_fmt_combo_->SetSampleFormat(SampleFormat::from_string(OLIVE_CONFIG("AudioOutputSampleFormat").toString()));
...

    {
      ...
      record_options_->channel_layout_combobox()->SetChannelLayout(AudioChannelLayout::fromString(OLIVE_CONFIG("AudioRecordingChannelLayout").toString()));
      record_options_->bit_rate_slider()->SetValue(OLIVE_CONFIG("AudioRecordingBitRate").toInt());
      record_options_->sample_format_combobox()->SetSampleFormat(SampleFormat::from_string(OLIVE_CONFIG("AudioRecordingSampleFormat").toString()));
...
void PreferencesAudioTab::Accept(MultiUndoCommand *command)
{
  ...
  OLIVE_CONFIG("AudioOutputChannelLayout") = output_ch_layout_combo_->GetChannelLayout().toString();
  OLIVE_CONFIG("AudioOutputSampleFormat") = output_fmt_combo_->GetSampleFormat().to_string();
  ...
  OLIVE_CONFIG("AudioRecordingChannelLayout") = record_options_->channel_layout_combobox()->GetChannelLayout().toString();
  OLIVE_CONFIG("AudioRecordingBitRate") = record_options_->bit_rate_slider()->GetValue();
  OLIVE_CONFIG("AudioRecordingSampleFormat") = record_options_->sample_format_combobox()->GetSampleFormat().to_string();
