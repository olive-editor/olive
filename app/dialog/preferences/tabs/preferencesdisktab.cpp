...
PreferencesDiskTab::PreferencesDiskTab()
{
  ...
  cache_ahead_slider_->SetFormat(QT_TRANSLATE_N_NOOP("olive::SliderBase", "%n second(s)"), true);
  ...
  cache_behind_slider_->SetFormat(QT_TRANSLATE_N_NOOP("olive::SliderBase", "%n second(s)"), true);
