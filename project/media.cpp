...
QString get_channel_layout_name(int channels, uint64_t layout) {
	switch (channels) {
    case 0: return QCoreApplication::translate("ChannelLayoutName", "Invalid"); break;
    case 1: return QCoreApplication::translate("ChannelLayoutName", "Mono"); break;
    case 2: return QCoreApplication::translate("ChannelLayoutName", "Stereo"); break;
	default: {
		char buf[50];
